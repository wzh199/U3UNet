...
class Stage1d(nn.Module):
    ...
    def __init__(self):
        ...
        self.stage1d = RSU7(128, 64, 128)
        ##

    # def forward(self, hx1, hx6, hx5d, hx4d, hx3d, hx2d):
    def forward(self, hx1, hx2d):
        ## stage1d
        # 分辨率：512 -> 512
        ...
        hx1d = self.stage1d(torch.cat((hx1to1d, hx2dto1d), 1))
        ##
...
class U3U515SimpleLayer(nn.Module):

    def __init__(self, in_ch=3, out_ch=1):
        super(U3U515SimpleLayer, self).__init__()
    ...
    def forward(self, x):
        ...
        #                         hx3d, hx2d)
        hx1d = self.stage1dfunc(hx1, hx2d)
        # side output
        d1 = self.side1(hx1d)
        d1 = _upsample_like(d1, x)
