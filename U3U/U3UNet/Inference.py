...
if __name__ == "__main__":
    ...
    dataset_path="/content/U3U/U3U-Net/diy_video_to_image"  #Your dataset path
    ...
    result_path="/content/U3U/U3U-Net/diy_video_to_image_result"  #The folder path that you want to save the results
