...
class KinectPublisher:
    ...
    def CreateRGBMessage(self,img_rgb):
        ...
        self.msg_rgb.header.frame_id = "camera2_rgb_optical_frame"
    ...
    def CreateDMessage(self,img_depth):
        ...
        self.msg_d.header.frame_id = "camera2_depth_optical_frame"
    ...
    def CreateInfoMessage(self):
        self.msg_info.header.frame_id = "camera2_rgb_optical_frame"
    ...
    def CreateTFMessage(self):
        ...
        self.msg_tf.transforms[0].header.frame_id = "/camera2_link"
        self.msg_tf.transforms[0].child_frame_id = "/camera2_rgb_frame"
        ...
        self.msg_tf.transforms[1].header.frame_id = "/camera2_rgb_frame"
        self.msg_tf.transforms[1].child_frame_id = "/camera2_rgb_optical_frame"
        ...
        self.msg_tf.transforms[2].header.frame_id = "/camera2_link"
        self.msg_tf.transforms[2].child_frame_id = "/camera2_depth_frame"
        ...
        self.msg_tf.transforms[3].header.frame_id = "/camera2_depth_frame"
        self.msg_tf.transforms[3].child_frame_id = "/camera2_depth_optical_frame"
...
if __name__ == "__main__":
    ...
    rospy.init_node('airsim2_publisher', anonymous=True)
    publisher_d = rospy.Publisher('/airsim/camera_2/depth_registered/image_raw', Image, queue_size=1)
    publisher_rgb = rospy.Publisher('/airsim/camera_2/rgb/image_rect_color', Image, queue_size=1)
    publisher_info = rospy.Publisher('/airsim/camera_2/rgb/camera_info', CameraInfo, queue_size=1)
    publisher_tf = rospy.Publisher('/airsim/camera_2/tf', TFMessage, queue_size=1)
    rate = rospy.Rate(100)  # 30hz
    pub = KinectPublisher()

    while not rospy.is_shutdown():
        responses = client.simGetImages([# airsim.ImageRequest("camera_2", airsim.ImageType.DepthPlanar, True, False),
        ...
        img_rgb = pub.getRGBImage(responses[0])
